...
<%@ taglib prefix="rb" uri="http://www.springframework.org/tags" %>
	...
	<html lang="ko" >
	<head>
		<title>xdmin Reservation List</title>
		<meta charset="UTF-8">
				...
				<div class="wrapper">
					<div class="container" style="height: 100vh; width: 93vh;">
						<div class="row">
							<div class="col">
								<div class="content">
									<h2 class="row needs-validation ms-3">Reservation List</h2>
										...
										<div class="row">
											<div class="col-md-3">
												<select class="form-select" id="shOption" name="shOption">
			                                        ...
			                                        <option value="3" <c:if test="${vo.shOption eq 3 }">selected</c:if>>주문자이름</option>
			                                    </select>                                   </select>
											</div>
											<div class="col-md-3">
...
<!-- <footer class="bg-dark">
		...
		var goUrlList = "/reservation/xdminReservationList"; 
		...
		var ifrvSeq = $("input[name=ifrvSeq]");
	 	...
	 	<script type="text/javascript">
	 		...
	 		var goUrlLita = "/reservation/xdminReservationLita";		
	 		...
	 		function setReservationLita() {
	 			$.ajax({
	 				...
	 				,success: function(response) {
	 					$("#reservationLita").empty();
	 					$("#reservationLita").append(response);
