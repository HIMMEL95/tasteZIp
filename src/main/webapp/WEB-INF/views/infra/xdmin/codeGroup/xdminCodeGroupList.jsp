...
<%@ taglib prefix="rb" uri="http://www.springframework.org/tags" %>
	...
	<html lang="ko" >
	<head>
		<title>xdmin CodeGroup List</title>
		<meta charset="UTF-8">
		  ...
		  <div class="page-content">
		  	...
		  	<%-- <%@include file="memberVo.jsp"%> --%>
				<input type="hidden" name="thisPage" value="1">
               	...
               	<input type="hidden" name="ifcgSeq" value="${vo.ifcgSeq}">
				<div class="wrapper">
					<div class="container" style="height: 100vh; width: 93vh;">
						<div class="row">
							<div class="col">
								<div class="content">
									<h2 class="row needs-validation ms-3">CodeGroup List</h2>
...
<!-- <footer class="bg-dark">
		...
		var ifcgSeq = $("input[name=ifcgSeq]");
	 	...
	 	<script type="text/javascript">
	 		...
	 		var goUrlLita = "/codeGroup/xdminCodeGroupLita";		
