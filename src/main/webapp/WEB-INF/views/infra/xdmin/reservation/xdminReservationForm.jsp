...
<!DOCTYPE html>
	...
	<head>
		...
		<title>xdmin Reservation Form</title>
		  ...
		  <form id="formList" name="formList" method="post" autocomplete="off">
			...
			<!-- *Vo.jsp e -->
				<div class="row" style="width: 1022px; height: 100%">
					<h2 class="needs-validation mt-5 ms-5">Reservation Form</h2>
						...
						<div class="start" style="margin-left: auto; margin-right: auto; width: 690px; display: grid;">
							<div class="row">
								<%-- <div class="col-6">
									...
									<input type="text" class="form-control" value="<c:out value="${item.ifrvSeq}"/>" readonly>
								</div> --%>
								<div class="col-6">
							...
							<div class="row mt-3">
								...
								<div class="col">
									<label class="form-label">예약수량</label> 
									<input type="text" value="<c:out value="${item.ifrvCount}"/>" class="form-control" readonly>
								</div>
							</div>
							<div class="row mt-3">
								<div class="col">
							...
							<div class="row mt-3">
								<div class="col">
									...
									<input type="text" value="<c:out value="${item.ifrvPerson}"/>" class="form-control" readonly>
								</div>
								<div class="col">
									<label class="form-label">예약금액</label> 
									<input type="text" value="<c:out value="${item.ifrvPrice}"/>" class="form-control" readonly>
								</div>
							</div>
							<div class="row mt-3">
								<div class="col">
									<label class="form-label">예약일</label> 
									<input type="text" value="<c:out value="${item.ifrvDate}"/>" class="form-control" readonly>
								</div>
								<div class="col">
									<label class="form-label">예약시간</label> 
									<input type="text" value="<c:out value="${item.ifrvTime}"/>" class="form-control" readonly>
								</div>
							</div>
						</div>
					</div>
