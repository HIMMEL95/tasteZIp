...
<html lang="ko">
	...
	<body>
		...
		<main>
			...
			<input type="hidden" name="ifrvSeq">
		...
		var goUrlList = "/reservation/reservationList"; 
		var goUrlInst = "/reservation/reservationUele";
		...
		<script type="text/javascript">
				...
				form.attr("action", "/reservation/reservationUele" ).submit();
				}
