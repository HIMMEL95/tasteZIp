		  ...
		  <div class="page-content">
		  	...
		  	<%-- <%@include file="memberVo.jsp"%> --%>
				<input type="hidden" name="thisPage" value="1">
               	...
               	<input type="hidden" name="ifccSeq" value="${vo.ifccSeq}">
				<div class="wrapper">
					<div class="container" style="height: 100vh; width: 100vh;">
						<div class="row">
							<div class="col">
								<div class="content">
									<h2 class="row needs-validation ms-3">Code List</h2>
...
<!-- <footer class="bg-dark">
		...
		var ifccSeq = $("input[name=ifccSeq]");
	 	...
	 	<script type="text/javascript">
	 		...
	 		var goUrlLita = "/code/xdminCodeLita";		
