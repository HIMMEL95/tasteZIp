				...
				<div class="container">
					<div class="row" style="height: 800px;">
						...
						<div class="col" style="padding-top: 20px;">
							<h2 class="needs-validation mt-2">My Menu Form</h2>
							<div class="content">
								<div class="row mt-3">
									<div class="col-6">	
						   			...
						   			<div class="col-6">
						   				<label for="name" class="form-label">가격명</label>
						   				<input type="text" class="form-control" id="" name="" value=""> 
					   				</div>
								</div>
								...
								<div class="row mt-3" style="margin-top: 3rem;">
									<div class="col-6">	
										<label for="name" class="form-label">할인 여부</label> 
						   			...
						   			<div class="col-6">
						   				<label for="name" class="form-label">삭제 여부</label>
						   				<select class="form-select" aria-label="Default select example" name="">
											<option value="">구분</option>
											<option value="">Y</option>
								  			<option value="">N</option>
								...
								<div class="row mt-3" style="margin-top: 3rem;">
									<div class="col-12">
										<label class="form-label">메뉴 이미지 첨부파일</label>
